...
function ChangelogModal() {
  return (
    ...
    <h1 style={{fontSize: 30}}>What's new? (January 2025)</h1>
    ...
    <br></br>
    <p style={{fontSize: 17, color: 'lightblue'}}>Join the <a href="https://discord.com/invite/9A9dNTGWb9" className="primary-link" target="_blank" rel="nofollow">Swordbattle.io Discord Server</a> to get a full changelog with MUCH more info on mastery, info on other updates you may have missed, and helpful tips and tricks, too!</p>
</div>
