...
const autoObjects = {
  Earth: (a) => [
    ...
    { type: 'Ore', amount: Math.round(a / 18e6), position: 'random', respawnable: true, respawnTime: [60 * 2, 60 * 6] },
    { type: 'Coin', amount: 0, position: 'random', respawnable: true },
    { type: 'Chest', amount: Math.round(a / 9.5e6), position: 'random', respawnable: true },
  ...
  'Earth:big': (a) => [
    ...
    { type: 'Bunny', amount: Math.round(a / 9.5e6), position: 'random', respawnable: true, size: [40, 60] },
    { type: 'Moose', amount: Math.round(a / 34e6), position: 'random', respawnable: true, size: [190, 250] },
    { type: 'Ore', amount: Math.round(a / 16e6), position: 'random', respawnable: true, respawnTime: [60 * 2, 60 * 6] },
    { type: 'Ancient', amount: 2, position: 'random', respawnable: true, respawnTime: [60 * 6, 60 * 14], size: [275, 375], health: 800, isBoss: true, damage: 9, rotationSpeed: 10, swordSize: 100, boulderSize: 200 },
    { type: 'AmbientShrub', amount: Math.round(a / 1e6), position: 'random', size: [40, 80], style: 'grass' },
    { type: 'AmbientShrub', kind: 'rock', amount: Math.round(a / 4e6), position: 'random', size: [40, 85] },
    { type: 'AmbientShrub', kind: 'flower', amount: Math.round(a / 3e6), position: 'random', size: [22, 48], spawnGap: 6, cluster: [3, 5], clusterChance: 0.35 },
  ],
  'Earth:safezone': (a) => [
    ...
    { type: 'Coin', amount: 0, position: 'random', respawnable: true },
    { type: 'Chest', amount: Math.round(a / 12e6), position: 'random', respawnable: true },
  ...
  Fire: (a) => [
    ...
    { type: 'Coin', amount: 0, position: 'random', respawnable: true },
    { type: 'Chest', amount: Math.round(a / 8.5e6), position: 'random', respawnable: true },
    ...
    { type: 'Ore', amount: Math.round(a / 14e6), position: 'random', respawnable: true, respawnTime: [60 * 2, 60 * 6], skin: 1 },
  ...
  Ice: (a) => [
    ...
    { type: 'Ore', amount: Math.round(a / 14e6), position: 'random', respawnable: true, respawnTime: [60 * 2, 60 * 6], skin: 4 },
  ...
  Alpine: (a) => [
    ...
    { type: 'Coin', amount: 0, position: 'random', respawnable: true },
    { type: 'Chest', amount: Math.round(a / 9e6), position: 'random', respawnable: true },
  ...
  Meadow: (a) => [
    ...
    { type: 'Coin', amount: 0, position: 'random', respawnable: true },
    { type: 'Chest', amount: Math.round(a / 10e6), position: 'random', respawnable: true },
    { type: 'Bunny', amount: Math.round(a / 8e6), position: 'random', respawnable: true, size: [40, 60] },
  ...
  Savanna: (a) => [
    ...
    { type: 'Rock', amount: Math.round(a / 20e6), position: 'random', size: [200, 400] },
    { type: 'Coin', amount: 0, position: 'random', respawnable: true },
    { type: 'Chest', amount: Math.round(a / 11e6), position: 'random', respawnable: true },
  ...
  Oasis: (a) => [
    ...
    { type: 'Bunny', amount: Math.round(a / 9e6), position: 'random', respawnable: true, size: [40, 60], skin: 1 },
    { type: 'Ore', amount: Math.round(a / 18e6), position: 'random', respawnable: true, respawnTime: [60 * 2, 60 * 6], skin: 2 },
  ...
  Desert: (a) => [
    ...
    { type: 'Ore', amount: Math.round(a / 16e6), position: 'random', respawnable: true, respawnTime: [60 * 2, 60 * 6], skin: 2 },
  ...
  Dirt: (a) => [
    ...
    { type: 'Wolf', amount: Math.round(a / 28e6), position: 'random', respawnable: true, size: [85, 105] },
    { type: 'Ore', amount: Math.round(a / 14e6), position: 'random', respawnable: true, respawnTime: [60 * 2, 60 * 6], skin: 3 },
    { type: 'AmbientShrub', kind: 'rock', amount: Math.round(a / 1.5e6), position: 'random', size: [40, 85] },
  ],
  'Dirt:corner': (a) => [
    { type: 'DeadBush', amount: Math.round(a / 1.5e6), position: 'random', size: [120, 320] },
  ...
  Rocks: (a) => [
    ...
    { type: 'Ore', amount: Math.round(a / 4e6), position: 'random', respawnable: true, respawnTime: [60 * 2, 60 * 6] },
    { type: 'Coin', amount: 0, position: 'random', respawnable: true },
    { type: 'Chest', amount: Math.round(a / 10e6), position: 'random', respawnable: true },
    { type: 'AmbientShrub', kind: 'rock', amount: Math.round(a / 1.5e6), position: 'random', size: [40, 85] },
    { type: 'Ore', amount: 1, position: 'center', boss: true, isBoss: true, rarity: 9, size: 1200, health: 8000, totalCoins: 50000, respawnable: true, respawnTime: [60 * 8, 60 * 14] },
  ],
