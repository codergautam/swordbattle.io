...
export default class Game extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('FoxMobPassive', publicPath + '/assets/game/mobs/foxPassive-winter.png');
    ...
    this.load.image('snowball', publicPath + '/assets/game/mobs/snowball-winter.png');
