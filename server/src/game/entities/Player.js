    ...
    if (this.health.isDead) {
      ...
      if (entity) {
        switch (entity.type) {
          ...
          case Types.Entity.Roku: reason = 'The Pudding Monster Roku'; break;
          case Types.Entity.Snowball: reason = 'Yeti Boss'; break; // the yeti boss throws snowballs
          case Types.Entity.Fireball: reason = 'The Pudding Monster Roku'; break; // the roku throws fireballs
        }
      }
