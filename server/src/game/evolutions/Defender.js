...
module.exports = class Defender extends Evolution {
  ...
  applyAbilityEffects() {
    ...
    this.player.sword.knockback.multiplier['ability'] = 6;
    this.player.knockbackResistance.multiplier *= 1.6;
    this.player.shape.setScale(1.7);
    this.player.health.regen.multiplier *= 6;
  ...
  update(dt) {
    ...
    this.player.sword.damage.multiplier *= 0.6;
    this.player.sword.knockback.multiplier['ability'] = 3;
    this.player.sword.swingDuration.multiplier['base'] = 1.25;
