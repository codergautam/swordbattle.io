const MinorCards = {
  1:  { id: 1,  name: 'Sharp Stabs',      category: 'offensive', values: [0.05, 0.04, 0.04, 0.03, 0.03, 0.02, 0.02], max: 7, stat: 'damage' },
  2:  { id: 2,  name: 'Quick Swing',      category: 'offensive', values: [0.06, 0.05, 0.05, 0.04, 0.04, 0.03, 0.03], max: 7, stat: 'attackSpeed', inverse: true },
  4:  { id: 4,  name: 'Sharpshooter',     category: 'offensive', values: [0.05, 0.04, 0.04, 0.03, 0.03, 0.02, 0.02], max: 7, stat: 'throwPower' },
...
const MajorCards = {
  ...
  103: { id: 103, name: 'Aggression',           category: 'swordsmanship', positiveText: '+30% damage for 2s after being hit', negativeText: '-25% damage for 1s after boost', stubEffect: { stat: 'damage', value: 0.10 } },
  ...
  // Predator
  107: { id: 107, name: 'Finisher',             category: 'predator',      positiveText: '+15% damage vs under 40% HP targets',     negativeText: '-15% damage vs over 80% HP targets',     stubEffect: { stat: 'damage', value: 0.10 } },
  ...
  115: { id: 115, name: 'Blood Frenzy',         category: 'vampiric',      positiveText: 'Under 35% HP: +15% damage, +5% speed',   negativeText: 'Over 80% HP: -10% damage',             stubEffect: { stat: 'damage', value: 0.10 } },
  ...
  // Beast Slayer
  125: { id: 125, name: 'Hunting Instinct',     category: 'beastSlayer',   positiveText: '+15% damage vs mobs, +10% mob coins',      negativeText: '-30% damage vs players',           stubEffect: { stat: 'damage', value: 0.10 } },
  ...
  127: { id: 127, name: 'Boss Hunter',          category: 'beastSlayer',   positiveText: '+10% boss damage',                  negativeText: '-80% damage vs mobs, bosses deal +20% damage', stubEffect: { stat: 'damage', value: 0.10 } },
