...
class TutorialOverlay extends HudComponent {
  ...
  initialize() {
    ...
    this.progressText = scene.add.text(0, 0, '', {
      fontSize: '14px', fontFamily: 'Rajdhani, sans-serif', fontStyle: 'bold',
    ...
    this.nextButtonText = scene.add.text(0, 0, 'Next \u2192', {
      fontSize: '14px', fontFamily: 'Rajdhani, sans-serif', fontStyle: 'bold', color: '#ffffff',
    }).setOrigin(0.5);
    ...
    this.arrowText = scene.add.text(0, 0, '\u2190', {
      fontSize: '64px', fontFamily: 'Rajdhani, sans-serif', fontStyle: 'bold',
